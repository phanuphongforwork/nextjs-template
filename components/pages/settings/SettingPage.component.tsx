...
const secondaryNavigation = [
  { name: "General", href: "#", icon: MdPerson, current: true },
  { name: "Security", href: "#", icon: MdFingerprint, current: false },
  { name: "Notifications", href: "#", icon: MdNotifications, current: false },
  { name: "Plan", href: "#", icon: MdInbox, current: false },
  { name: "Billing", href: "#", icon: MdCreditCard, current: false },
  { name: "Team members", href: "#", icon: MdGroup, current: false },
];
